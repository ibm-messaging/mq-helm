...
docker run -it --rm --env MQCCDTURL="/home/mqm/ccdt_generated.json" --env MQSSLKEYR="/home/mqm/createcerts/application" --volume ${DIR}:/home/mqm --volume ${DIR}/../../genericresources/createcerts:/home/mqm/createcerts  --entrypoint /bin/sh ibmcom/mq:latest -c "/opt/mqm/samp/bin/amqsghac APPQ secureapphelm"
